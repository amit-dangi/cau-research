...
.responsive-iframe {
 ...
 <%	
	...
	meeting_type_id=General.checknull(request.getParameter("meeting_type_id"));
	others=General.checknull(request.getParameter("others"));
...
/* 	  Create a zip file by ZipUtils require the two string OUTPUT_ZIP_FILE where to create zip ,
  ...
  String FOLDER_NAME=  "MEETING";
  if(mode.equals("Attach")){
   returnurl=rsrchFilesDownload.downloadUploadedDoc(FOLDER_NAME,locationCode,ddoCode,meeting_type_id,
		   					others,fin_yr,"","","","","");
  }
	try{
   	if(returnurl.contains(".zip")){
		...
		System.out.println("meeting_mapping_report.jsp :"+e);
	}
...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Meeting Mapping Report</h4>	
 </div>	
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btnreset").click(function(){
				window.location.href="meeting_mapping_report.jsp"
			});
		});
		...
		var jaspername='meeting_mapping_report';
		...
		function downloadJasperReport()
		{
			    ...
			    var url=tibcoserverUrl+"?_flowId=viewReportFlow&_flowId=viewReportFlow&ParentFolderUri=%2Freports&reportUnit="+folder_name
							 		...
							 		+"&ddoCode="+ddoCode+"&meeting_type_id="+meeting_type_id
							 		+"&others="+others+"&fin_yr="+fin_yr;
							 		;
		...
		function downloadUploadedDoc(){
			/* alert("in"); */
			document.frmTotalTailwiseReportD.action="meeting_mapping_report.jsp?mode=Attach" ;
		...
		<div class="form-group" >
			...
			<div class="col-md-12">
					<div class="row" >
						...
						<div class="col-sm-4">
						<input type="text" maxlength="100" class="form-control" id="others" name="others" value="All" onblur="Alpha(this);"  placeholder="Enter others" readonly>
				       	</div>
