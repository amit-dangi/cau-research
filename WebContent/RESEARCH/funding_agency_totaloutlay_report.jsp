...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Funding Agency Total Outlay Report</h4>	
 </div>	
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btnreset").click(function(){
				window.location.href="funding_agency_totaloutlay_report.jsp"
			});
		});
		...
		var jaspername='funding_agency_totaloutlay_report';
