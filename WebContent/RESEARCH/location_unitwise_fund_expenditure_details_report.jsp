...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Location Unitwise Fund Expenditure Details Report</h4>	
 </div>	
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#btnreset").click(function(){
				window.location.href="location_unitwise_fund_expenditure_details_report.jsp"
			});
		});
		...
		var jaspername='FundAICRPDetailsCAUHQ';
