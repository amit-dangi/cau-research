...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Location Unitwise Fund Remitted Details Report</h4>	
 </div>	
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#btnreset").click(function(){
				window.location.href="location_unitwise_fund_remitted_details_report.jsp"
			});
		});
		...
		function downloadJasperReport()
		{
			    ...
			    var url=tibcoserverUrl+"?_flowId=viewReportFlow&_flowId=viewReportFlow&ParentFolderUri=%2Freports&reportUnit="+folder_name
							 		...
							 		+"&locationCode="+locationCode+"&ddoCode="+ddoCode+"&fundingAgency="+fundingAgency+"&fin_yr="+fin_yr;
			...
			<div class="col-md-12">
           	...
           	<label class="col-sm-2 col-form-label text-left required-field" for="">Funding Agency</label>
							<div class="col-sm-4">
								...
								<select class="form-control" id="fnagency" name="fnagency" >
									<option value="%">All</option>
