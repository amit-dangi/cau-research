...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Project Utilization Report	</h4>	
 </div>	
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btnreset").click(function(){
				window.location.href="project_utilization_report.jsp"
			});
		});
		...
		//var jaspername='project_utilization_report_new';
		var jaspername='project_utilization_report';
		function downloadJasperReport()
		{
			    ...
			    if(resPrps == ""){ 
			 		$('#resPrps').focus();	
						showerr($("#resPrps")[0], "Name of the project is required.","block");
						return false;	
				}
					...
					<div class="row">
				       ...
				       <!-- <div id="erptypediv" style="display: none;">
						<label class="col-sm-2 col-form-label text-left" for="">ERP Type</label>
				          ...
				          <label for="" class="col-sm-2 col-form-label required-field">Name of the project</label>
							<div class="col-sm-4">
