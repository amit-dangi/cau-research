...
<div id="ftitleHeader" class="page-header"><h4>Statement Of Expenditure</h4></div>
		...
		<div class="form-group">
			...
			<div class="row">
			 <label for="" class="col-sm-2 col-form-label">Project</label>
               ...
               <label for="toDATE" class="col-sm-1 col-form-label">Month</label>
               <div class="col-sm-2">
                   <select class="form-control" id="" name="">
	...
	src="" width="100%" onload="resizeIframe(this)" scrolling="no" height="" frameborder="0" style="overflow-y: hidden;" ></iframe>
