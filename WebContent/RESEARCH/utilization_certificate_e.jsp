...
<head>
    ...
    <script type="text/javascript" src="../js/research/utilization-certificate.js"></script>
...
%>
<!-- commonDropDown.js will be used for call the getResearchProposal -->
...
<body onload="getResearchProposal('<%=loct_id%>','<%=ddo_id%>');  getLocationDetail('<%=loct_id%>'); getDdoDetailbyLocation('<%=loct_id%>','<%=ddo_id%>'); getFinanceYrDropdwn('<%=seCurrentFinancialYearId%>','finYr');">
	<div class="container-fluid">
	    <div id="" class="page-header"><h4 ><%=ReadProps.getkeyValue("res_fin_utilization_certificate.header","sitsResource") %></h4>
	 </div>
     ...
     <div class="panel-heading"><h3 class="panel-title text-right">UC/AUC</h3></div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-12 text-center m-b-15">
					<button type="button" class="btn btn-view" id="btnView" onclick="getUtilizationCertificateDetail();">View</button>					
