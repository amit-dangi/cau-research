...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" placeholder="Select Hour" name="hour" class="bootstrap-timepicker-hour form-control" maxlength="2"/>';
        minuteTemplate = '<input type="text" placeholder="Select Minute" name="minute" class="bootstrap-timepicker-minute form-control" maxlength="2"/>';
